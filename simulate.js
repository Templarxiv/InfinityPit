...
var startSimulation = () => {
  document.getElementById("status").innerHTML = simulate(jsonData.find(x => x.Name == document.getElementById("first_unit").value), jsonData.find(x => x.Name == document.getElementById("second_unit").value));
}
